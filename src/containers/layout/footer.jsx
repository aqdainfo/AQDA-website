    ...
    <footer className="footer">
      <div className="footer__top">
        ...
        <div className="footer__social">
          <a href={social.twitter} rel="noreferrer" target="_blank" className="footer__social__link footer__social__link--twitter">
          ...
          <a href={social.youtube} rel="noreferrer" target="_blank" className="footer__social__link footer__social__link--youtube">
          ...
          <a href={social.linkedin} rel="noreferrer" target="_blank" className="footer__social__link footer__social__link--linkedin">
          ...
          <a href={social.facebook} rel="noreferrer" target="_blank" className="footer__social__link footer__social__link--facebook">
            <svg width="29" height="30" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg">
